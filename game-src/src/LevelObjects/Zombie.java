...
/**
 * Class represents an enemy(Zombie) with its graphics and properties
...
public class Zombie extends NPC {	
	...
	/*
	 * ZombieMaster spezifische Eigenschaften
	 ...
	 * @param npcType
	 */
	public Zombie(short id, Position position, Block parentBlock, boolean disabled, int npcType, byte itemWhenDying) {
		...
		try {
			...
			sprite.defineReferencePixel(8, 16);
		}
		catch (Exception e){
	...
	/*
	 * Autmatisierter Test der Klasse Zombie
	 */
	public String imageTest(Zombie enemy,int npctype) {
		try {
